...
**Für dieses Projekt gewählt:** **Runtipi** (App-Store) + **Cockpit** (Host-Monitoring),
beide ausschließlich über WireGuard erreichbar. Die schwereren Panels (ab ~1 GB Disk)
passen nicht zur schlanken Zielsetzung; die leichten Docker-nativen Kandidaten (Dokku,
Cosmos, InfraPilot, Runtipi, Easypanel) blieben in der engeren Wahl.
