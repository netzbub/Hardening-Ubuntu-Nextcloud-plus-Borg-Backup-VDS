...
**Chosen for this project:** **Runtipi** (app store) + **Cockpit** (host monitoring), both
reachable only over WireGuard. The heavier panels (from ~1 GB disk) do not fit the lean
goal; the light, Docker-native candidates (Dokku, Cosmos, InfraPilot, Runtipi, Easypanel)
stayed on the shortlist.
